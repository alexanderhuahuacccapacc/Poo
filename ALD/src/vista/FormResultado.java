...
public class FormResultado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelFondo.setForeground(new java.awt.Color(255, 102, 102));
        ...
        lblCierre.setBounds(420, 190, 30, 32);
        ...
        lblNombre.setText("BAD");
        lblNombre.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        panelFondo.add(lblNombre);
        lblNombre.setBounds(20, 90, 420, 50);

        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("JUGAR DE NUEVO");
        panelFondo.add(jLabel2);
        jLabel2.setBounds(270, 200, 140, 24);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(panelFondo, javax.swing.GroupLayout.PREFERRED_SIZE, 464, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelFondo, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
        );
