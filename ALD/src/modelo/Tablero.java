        ...
        MouseListener evento = new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if(jugadorActual==TipoImagen.EQUIS){
                    ...
                    BAD.getTablero()[cuadro.getI()][cuadro.getJ()]=1;
                    tipoImagenResultado = BAD.tresEnRaya(WELL);
                    ...
                    WELL.getTablero()[cuadro.getI()][cuadro.getJ()]=1;
                    tipoImagenResultado= WELL.tresEnRaya(BAD);
